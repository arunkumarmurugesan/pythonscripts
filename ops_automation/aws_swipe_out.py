...
class Delete_Default_VPC(object):
    ...
    def __init__(self):
        ...
        self.secret_key = "xxx"
#        self.ec2_conn_client = boto3.client(self.service_type, self.zone_name, aws_access_key_id=self.access_key,aws_secret_access_key=self.secret_key)
#        self.ec2_conn_resource = boto3.resource(self.service_type, self.zone_name, aws_access_key_id=self.access_key,aws_secret_access_key=self.secret_key)
    ...
    def describe_regions(self):
        ...
        try:
            ...
            for data in region_list:
                print data
                self.region_connect = boto3.client(self.service_type, data)
